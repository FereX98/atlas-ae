...
### Running
target_mops_arr=(0.05 0.1 0.15 0.2 0.25 0.3 0.35 0.4 0.45 0.5 0.55)
num_threads_arr=(20)

sudo cgcreate -t $USER -a $USER -g memory:/hash
log_file="/home/osdi/ae/results/fig5a"
...
function run {
    ...
    python3 /home/osdi/ae/results/fig5a/process.py
}
